...
do { 
    ...
    "6" {
            ...
            $toneroutput = "toner levels are at $tonerLevel percent"
            $toneroutput | Out-File -FilePath ".\PrinterData-$IP.txt" -Append
        }
    "7" {invoke-snmpwalk -IP $IP -OID $pagecount  | Out-File -FilePath ".\PrinterData-$IP.txt" -Append}
